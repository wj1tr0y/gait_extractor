...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pixel_shuffle_param', full_name='caffe.LayerParameter.pixel_shuffle_param', index=66,
      number=888, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
...
_LAYERPARAMETER.fields_by_name['pixel_shuffle_param'].message_type = _PIXELSHUFFLEPARAMETER
...
PixelShuffleParameter = _reflection.GeneratedProtocolMessageType('PixelShuffleParameter', (_message.Message,), dict(
